...
export default async function Common__R({ item }: { item: any }) {
    ...
    return (
        <div className="section relative">
            <div className="container md:flex justify-between items-center gap-5 lg:gap-[100px] relative z-10 ">
                ...
                <div className="w-full md:w-[50%] lg:w-[45%] flex justify-end  pt-5 md:pt-0" >

                    <div className=" relative border p-[30px] w-full max-w-[480px] rounded-[7px] overflow-hidden ">
                        ...
                        <ul className={` py-[15px]`}>
                            {
                                ...
                                sectionData?.lists?.map((item: any, idx: any) => (
                                    <li key={idx} className="flex items-center gap-2 text-secondary pb-[5px] phone_text_center">
                            ...
                            {/* w-[165px] h-[40px] text-heading text-[16px] font-[500] py-[7px] px-[10px] rounded-full bg-[#F2F2F2] */}
                        </ul>
                        <CustomButton
                            label="Call Us Now"
